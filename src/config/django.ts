...
export const PROJECT_COMPLETED_URL = (id: string) => `${ROOT_URL}/projects/${id}/completed/`;
export const PROJECT_EMPLOYEES_URL = (id: string) => `${ROOT_URL}/projects/${id}/employees/`;

export const TASKS_URL = (project_id: string) => `${ROOT_URL}/projects/${project_id}/tasks/`;
export const TASK_URL = (pid: string, id: string) => `${ROOT_URL}/projects/${pid}/tasks/${id}/`;
export const TASK_COMPLETED_URL = (pid: string, id: string) => `${ROOT_URL}/projects/${pid}/tasks/${id}/completed/`;
